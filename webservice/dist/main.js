...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"BasePermitter\", function() { return BasePermitter; });\n/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../logger */ \"./src/logger.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\nvar BasePermitter =\n/*#__PURE__*/\nfunction () {\n  function BasePermitter(key, ac) {\n    _classCallCheck(this, BasePermitter);\n\n    this.key = key;\n    this.ac = ac;\n  }\n\n  _createClass(BasePermitter, [{\n    key: \"isOwn\",\n    value: function isOwn(obj, user) {\n      return true;\n    }\n  }, {\n    key: \"canCreate\",\n    value: function canCreate(obj, user) {\n      for (var i = 0; i < user.roles.length; i++) {\n        var role = user.roles[i];\n        var permission = this.isOwn(obj, user) ? this.ac.can(role).createOwn(this.key) : this.ac.can(role).createAny(this.key);\n        _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Checking permission for [\".concat(user.name, \"] to create [\").concat(this.isOwn(obj, user) ? 'own' : 'not own', \"] [\").concat(this.key, \"] with role [\").concat(role, \"]...\"));\n\n        if (permission.granted) {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Permission to create [\".concat(this.key, \"] granted by role [\").concat(role, \"] for [\").concat(user.name, \"].\"));\n          return true;\n        } else {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Permission to create [\".concat(this.key, \"] with role [\").concat(role, \"] denied for [\").concat(user.name, \"].\"));\n        }\n      }\n\n      _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Permission to create [\".concat(this.key, \"] denied for [\").concat(user.name, \"].\"));\n      return false;\n    }\n  }, {\n    key: \"canRead\",\n    value: function canRead(obj, user) {\n      for (var i = 0; i < user.roles.length; i++) {\n        var role = user.roles[i];\n        var permission = this.isOwn(obj, user) ? this.ac.can(role).readOwn(this.key) : this.ac.can(role).readAny(this.key);\n        _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Checking permission for [\".concat(user.name, \"] to read [\").concat(this.isOwn(obj, user) ? 'own' : 'not own', \"] [\").concat(this.key, \"] with role [\").concat(role, \"]...\"));\n\n        if (permission.granted) {\n          return true;\n        } else {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Permission to read [\".concat(this.key, \"] with role [\").concat(role, \"] denied for [\").concat(user.name, \"].\"));\n        }\n      }\n\n      _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Permission to read [\".concat(this.key, \"] denied for [\").concat(user.name, \"].\"));\n      return false;\n    }\n  }, {\n    key: \"canUpdate\",\n    value: function canUpdate(obj, user) {\n      for (var i = 0; i < user.roles.length; i++) {\n        var role = user.roles[i];\n        var permission = this.isOwn(obj, user) ? this.ac.can(role).updateOwn(this.key) : this.ac.can(role).updateAny(this.key);\n        _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Checking permission for [\".concat(user.name, \"] to update [\").concat(this.isOwn(obj, user) ? 'own' : 'not own', \"] [\").concat(this.key, \"] with role [\").concat(role, \"]...\"));\n\n        if (permission.granted) {\n          return true;\n        } else {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Permission to update [\".concat(this.key, \"] with role [\").concat(role, \"] denied for [\").concat(user.name, \"].\"));\n        }\n      }\n\n      _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Permission to update [\".concat(this.key, \"] denied for [\").concat(user.name, \"].\"));\n      return false;\n    }\n  }, {\n    key: \"canDelete\",\n    value: function canDelete(obj, user) {\n      for (var i = 0; i < user.roles.length; i++) {\n        var role = user.roles[i];\n        var permission = this.isOwn(obj, user) ? this.ac.can(role).deleteOwn(this.key) : this.ac.can(role).deleteAny(this.key);\n        _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Checking permission for [\".concat(user.name, \"] to delete [\").concat(this.isOwn(obj, user) ? 'own' : 'not own', \"] [\").concat(this.key, \"] with role [\").concat(role, \"]...\"));\n\n        if (permission.granted) {\n          return true;\n        } else {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Permission to delete [\".concat(this.key, \"] with role [\").concat(role, \"] denied for [\").concat(user.name, \"].\"));\n        }\n      }\n\n      _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', \"[SECURITY]: Permission to delete [\".concat(this.key, \"] denied for [\").concat(user.name, \"].\"));\n      return false;\n    }\n  }]);\n\n  return BasePermitter;\n}();\n\n//# sourceURL=webpack:///./src/services/security/permitters/basePermitter.js?");
