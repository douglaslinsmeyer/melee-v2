...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return combatManager; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar combatManager =\n/*#__PURE__*/\nfunction () {\n  function combatManager() {\n    _classCallCheck(this, combatManager);\n\n    this._victoryConditions = [];\n    this._validActions = [];\n  }\n\n  _createClass(combatManager, [{\n    key: \"registerVictoryCondition\",\n    value: function registerVictoryCondition(name, callback) {\n      for (var i = 0; i < this._victoryConditions.length; i++) {\n        if (this._victoryConditions[i].name === name) {\n          throw \"Unable to register victory condition [\".concat(name, \"], a condition with that name has already been registered.\");\n        }\n      }\n\n      this._victoryConditions.push({\n        name: name,\n        callback: callback\n      });\n    }\n  }, {\n    key: \"registerValidAction\",\n    value: function registerValidAction(action) {\n      if (this._validActions.includes(action)) {\n        return;\n      }\n\n      this._validActions.push(action);\n    }\n  }]);\n\n  return combatManager;\n}();\n\n\n\n//# sourceURL=webpack:///./src/combat/combatManager.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"BasePermitter\", function() { return BasePermitter; });\n/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../logger */ \"./src/logger.js\");\nvar _this = undefined;\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar permissionCheckingMessage = function permissionCheckingMessage(action, userName, own, object, role) {\n  return \"[SECURITY]: Checking permission of [\".concat(userName, \"] to \").concat(action, \" [\").concat(own ? 'own' : 'not own', \"] [\").concat(object, \"] with role [\").concat(role, \"]...\");\n};\n\nvar permissionGrantedByRoleMessage = function permissionGrantedByRoleMessage(action, userName, own, object, role) {\n  return \"[SECURITY]: Permission to \".concat(action, \" [\").concat(own ? 'own' : 'not own', \"] [\").concat(object, \"] granted to [\").concat(userName, \"] by role [\").concat(role, \"].\");\n};\n\nvar permissionDeniedByRoleMessage = function permissionDeniedByRoleMessage(action, userName, own, object, role) {\n  return \"[SECURITY]: Permission to \".concat(action, \" [\").concat(own ? 'own' : 'not own', \"] [\").concat(object, \"] denied to [\").concat(userName, \"] by role [\").concat(role, \"].\");\n};\n\nvar permissionDeniedMessage = function permissionDeniedMessage(action, userName, own) {\n  return \"[SECURITY]: Permission to \".concat(action, \" [\").concat(own ? 'own' : 'not own', \"] [\").concat(_this.key, \"] denied for [\").concat(userName, \"].\");\n};\n\nvar BasePermitter =\n/*#__PURE__*/\nfunction () {\n  function BasePermitter(key, ac) {\n    _classCallCheck(this, BasePermitter);\n\n    this.key = key;\n    this.ac = ac;\n  }\n\n  _createClass(BasePermitter, [{\n    key: \"isOwn\",\n    value: function isOwn(obj, user) {\n      return true;\n    }\n  }, {\n    key: \"canCreate\",\n    value: function canCreate(obj, user) {\n      for (var i = 0; i < user.roles.length; i++) {\n        var role = user.roles[i];\n        var permission = this.isOwn(obj, user) ? this.ac.can(role).createOwn(this.key) : this.ac.can(role).createAny(this.key);\n        _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionCheckingMessage('create', user.name, this.isOwn(obj, user), this.key, role));\n\n        if (permission.granted) {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionGrantedByRoleMessage('create', user.name, this.isOwn(obj, user), this.key, role));\n          return true;\n        } else {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionDeniedByRoleMessage('create', user.name, this.isOwn(obj, user), this.key, role));\n        }\n      }\n\n      _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionDeniedMessage('create', user.name, this.isOwn(obj, user), this.key));\n      return false;\n    }\n  }, {\n    key: \"canRead\",\n    value: function canRead(obj, user) {\n      for (var i = 0; i < user.roles.length; i++) {\n        var role = user.roles[i];\n        var permission = this.isOwn(obj, user) ? this.ac.can(role).readOwn(this.key) : this.ac.can(role).readAny(this.key);\n        _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionCheckingMessage('read', user.name, this.isOwn(obj, user), this.key, role));\n\n        if (permission.granted) {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionGrantedByRoleMessage('read', user.name, this.isOwn(obj, user), this.key, role));\n          return true;\n        } else {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionDeniedByRoleMessage('read', user.name, this.isOwn(obj, user), this.key, role));\n        }\n      }\n\n      _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionDeniedMessage('read', user.name, this.isOwn(obj, user), this.key));\n      return false;\n    }\n  }, {\n    key: \"canUpdate\",\n    value: function canUpdate(obj, user) {\n      for (var i = 0; i < user.roles.length; i++) {\n        var role = user.roles[i];\n        var permission = this.isOwn(obj, user) ? this.ac.can(role).updateOwn(this.key) : this.ac.can(role).updateAny(this.key);\n        _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionCheckingMessage('update', user.name, this.isOwn(obj, user), this.key, role));\n\n        if (permission.granted) {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionGrantedByRoleMessage('update', user.name, this.isOwn(obj, user), this.key, role));\n          return true;\n        } else {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionDeniedByRoleMessage('update', user.name, this.isOwn(obj, user), this.key, role));\n        }\n      }\n\n      _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionDeniedMessage('update', user.name, this.isOwn(obj, user), this.key));\n      return false;\n    }\n  }, {\n    key: \"canDelete\",\n    value: function canDelete(obj, user) {\n      for (var i = 0; i < user.roles.length; i++) {\n        var role = user.roles[i];\n        var permission = this.isOwn(obj, user) ? this.ac.can(role).deleteOwn(this.key) : this.ac.can(role).deleteAny(this.key);\n        _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionCheckingMessage('delete', user.name, this.isOwn(obj, user), this.key, role));\n\n        if (permission.granted) {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionGrantedByRoleMessage('delete', user.name, this.isOwn(obj, user), this.key, role));\n          return true;\n        } else {\n          _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionDeniedByRoleMessage('delete', user.name, this.isOwn(obj, user), this.key, role));\n        }\n      }\n\n      _logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"].log('info', permissionDeniedMessage('delete', user.name, this.isOwn(obj, user), this.key));\n      return false;\n    }\n  }]);\n\n  return BasePermitter;\n}();\n\n//# sourceURL=webpack:///./src/services/security/permitters/basePermitter.js?");
